              ...
              <div className="about-new-img-col">
                ...
                >
                  <g clipPath="url(#clip0_home_210)">
                    ...
                    />
                    <path
                      d="M291.5 13L427 88.75V240.25L291.5 316L156 240.25V88.75L291.5 13Z"
                      fill="url(#hpaint1)"
                      stroke="#E8ECF3"
                      strokeWidth="0.5"
                    />
                    <path
                      d="M291.5 66L385 119.5V226.5L291.5 280L198 226.5V119.5L291.5 66Z"
                      fill="url(#hpaint2)"
                    />
                    <path
                      d="M291.5 108L361 148.5V229.5L291.5 270L222 229.5V148.5L291.5 108Z"
                      fill="url(#hpaint3)"
                    />
                    <path
                      d="M291.5 149L338 176.5V231.5L291.5 259L245 231.5V176.5L291.5 149Z"
                      fill="url(#hpaint4)"
                    />
                    <path
                      d="M291.5 185L319.5 201.5V234.5L291.5 251L263.5 234.5V201.5L291.5 185Z"
                      fill="#FFB01E"
                    />
                    <path
                      d="M291.5 316L156 400.25V488.5"
                      stroke="#E8ECF3"
                      strokeWidth="0.5"
                    />
                    <path
                      d="M291.5 316L427 400.25V488.5"
                      stroke="#E8ECF3"
                      strokeWidth="0.5"
                    />
                    <path
                      d="M156 240.25V400.25"
                      stroke="#E8ECF3"
                      strokeWidth="0.5"
                    />
                    <path
                      d="M427 240.25V400.25"
                      stroke="#E8ECF3"
                      strokeWidth="0.5"
                    />
                    <circle cx="291.5" cy="218" r="8" fill="#FFB01E" />
                    <circle
                      cx="291.5"
                      cy="218"
                      r="14"
                  ...
                  <defs>
                    ...
                    >
                      <stop stopColor="#F8F9FC" />
                      <stop offset="1" stopColor="#E8ECF3" />
                    </linearGradient>
                    <linearGradient
                      id="hpaint2"
                      x1="291.5"
                    ...
                    <linearGradient
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#E3E8F2" />
                      <stop offset="1" stopColor="#CDD4E3" />
                    </linearGradient>
                    <linearGradient
                      id="hpaint4"
                      x1="291.5"
                      ...
                      gradientUnits="userSpaceOnUse"
                    >
                      <stop stopColor="#D5DCE9" />
                      <stop offset="1" stopColor="#BFC8D9" />
                    </linearGradient>
                    <clipPath id="clip0_home_210">
