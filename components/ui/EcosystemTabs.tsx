...
const THRESHOLDS = [0, 0.17, 0.33, 0.5, 0.67, 0.84]
...
export default function EcosystemTabs() {
  ...
  /* Progress bar position: each item ~16.67% of the track */
    ...
    <div className="eco-section">
      ...
      <div ref={scrollRef} className="eco-scroll">
        <div className="eco-sticky">
          ...
          <div className="eco-left">
            ...
            <div className="eco-nav-list">
              {ECOSYSTEM.map((item, i) => (
                <div
                  key={i}
                  className={`eco-nav-item ${active === i ? 'eco-nav-item--active' : ''}`}
                >
          ...
          {/* Right — card with image + title + bullets */}
