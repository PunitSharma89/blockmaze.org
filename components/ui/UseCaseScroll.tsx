  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      gsapCtx = gsap.context(() => {
        // Activate each item when it enters the viewport center
        ...
        // Animate the progress fill line
        ...
        <div className="ucs-inner">
          ...
          <div className="ucs-left">
            ...
            <p className="ucs-subtext">
              Blockmaze supports asset issuance models where verified
              authorization, structured disclosure, and protocol-level
